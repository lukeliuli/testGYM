...
class TrustRegionPolicyOptimization(TensorforceAgent):
    ...
    Args:
        ...
        linesearch_iterations (<a href="../modules/parameters.html">parameter</a>, int >= 0):
        ...
        subsampling_fraction (<a href="../modules/parameters.html">parameter</a>, int > 0 | 0.0 < float <= 1.0):
            Absolute/relative fraction of batch timesteps to subsample for computation of natural
            gradient update
    ...
    def __init__(
        ...
        # Reward estimation
        discount=0.99, reward_processing=None, return_processing=None, advantage_processing=None,
